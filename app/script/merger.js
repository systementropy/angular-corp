(function() {
    ...
    angular.module('myApp.merger', ['ngRoute'])

    .config(['$routeProvider',
        function($routeProvider) {
            $routeProvider.when('/merger', {
                templateUrl: '/view/merger.html',
                controller: 'mergerCtrl'
            });
        }
    ])

    .controller('mergerCtrl', ['$rootScope' ,'$scope', '$http','$timeout','$location','parallaxHelper','$window', function($rootScope,$scope, $http,$timeout,$location,parallaxHelper,$window) {
