(function() {
    ...
    angular.module('myApp.shareholding', ['ngRoute'])

    .config(['$routeProvider',
        function($routeProvider) {
            $routeProvider.when('/shareholding', {
                templateUrl: '/view/shareholding.html',
                controller: 'shareholdingCtrl'
            });
        }
    ])

    .controller('shareholdingCtrl', ['$rootScope' ,'$scope', '$http','$timeout','$location','parallaxHelper','$window', function($rootScope,$scope, $http,$timeout,$location,parallaxHelper,$window) {
