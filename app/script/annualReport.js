(function() {
    ...
    angular.module('myApp.annualReport', ['ngRoute'])

    .config(['$routeProvider',
        function($routeProvider) {
            $routeProvider.when('/annualReport', {
                templateUrl: '/view/annualReport.html',
                controller: 'annualReportCtrl'
            });
        }
    ])

    .controller('annualReportCtrl', ['$rootScope' ,'$scope', '$http','$timeout','$location','parallaxHelper', function($rootScope,$scope, $http,$timeout,$location,parallaxHelper) {
